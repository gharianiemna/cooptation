...
import {Component, ViewChild, AfterViewInit, ChangeDetectorRef, AfterContentChecked, AfterViewChecked} from '@angular/core';
...
@Component({
  ...
  styleUrls: ['./retrieving-data-through-http.component.css']
})
