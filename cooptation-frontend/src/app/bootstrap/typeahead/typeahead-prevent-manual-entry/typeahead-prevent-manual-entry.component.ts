...
@Component({
  selector: 'app-typeahead-prevent-manual-entry',
  templateUrl: './typeahead-prevent-manual-entry.component.html',
  styleUrls: ['./typeahead-prevent-manual-entry.component.css']
})
export class TypeaheadPreventManualEntryComponent implements OnInit {
