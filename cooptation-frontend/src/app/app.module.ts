...
import { IdentityCooptedFormComponent } from './components/identity-coopted-form/identity-coopted-form.component';
import { InformationCoopteFormComponent } from './components/information-coopte-form/information-coopte-form.component';
import { CooptationsHeaderComponent } from './components/cooptations-header/cooptations-header.component';
...
import { FirstInterviewFormComponent } from './components/first-interview-form/first-interview-form.component';
import { CooptationTableComponent, NgbdModalWorkflow } from './core/cooptation-list/cooptation-table/cooptation-table.component';
import { AlertModule } from 'ngx-alerts';
import { WorkflowComponent } from './components/workflow/workflow.component';
import { CooptationViewComponent } from './components/cooptation-view/cooptation-view.component';
import { ViewFirstInterviewComponent } from './components/view-first-interview/view-first-interview.component';
import { ViewIdentityCooptedComponent } from './components/view-identity-coopted/view-identity-coopted.component';
import { ViewInformationCoopteComponent } from './components/view-information-coopte/view-information-coopte.component';
import { ManagerCooptationComponent,  NgbdModalManager } from './core/manager-cooptation/manager-cooptation.component';
import { AdminCooptationComponent, NgbdModalAdmin, NgbdModalConfirm } from './core/admin-cooptation/admin-cooptation.component';
import { TableHeaderComponent } from './core/manager-cooptation/table-header/table-header.component';
import { ManagerPoleCooptationComponent, NgbdModalPoleManager } from './core/manager-cooptation/manager-pole-cooptation/manager-pole-cooptation.component';
...
@NgModule({
  declarations: [
    ...
    NgbdSortableHeader,
    LoginUserComponent,
    IdentityCooptedFormComponent,
    CooptationTableComponent,
    AdminComponent,
    LoadingComponent,
    NavHeaderComponent,
    HeaderComponent,
    ...
    SwitcherComponent,
          IdentityCooptedFormComponent,
          InformationCoopteFormComponent,
          CooptationsHeaderComponent,
          NgbdModalWorkflow,
          CooptationRequestComponent,
          CooptationEditComponent,
          FirstInterviewFormComponent,
          CooptationListComponent,
          WorkflowComponent,
          ManagerCooptationComponent,
          NgbdModalManager,
          AdminCooptationComponent,
          NgbdModalAdmin,
          CooptationViewComponent,
          ViewFirstInterviewComponent,
          ViewIdentityCooptedComponent,
          ViewInformationCoopteComponent,
          TableHeaderComponent,
          NgbdModalPoleManager,
          ManagerPoleCooptationComponent,
