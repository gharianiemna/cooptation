...
class UserController extends AbstractController
{
   ...
   protected $validator;
   private $security;
   public function __construct(EntityManagerInterface $entityManager,UserRepository $userRepo,UserPasswordEncoderInterface $userPasswordEncoder,Security $security,
   ...
   */
     public function getUserName()
    {
      ...
      /**
   * @Rest\GET("api/userPole", name="userPole")
   * @Rest\View(serializerGroups={"userPole"})
   */
     public function getUserPole()
    {
        $user = $this->security->getUser();
         return $this->json($user->getPole()->getName());
